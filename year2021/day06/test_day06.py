...
class TestSanta(unittest.TestCase):
    ...
    def test_lanternfish_counters(self):
        ...
        self.assertEqual(day06.number_of_lanternfish_counters(lanternfish_data, 80), 5934)
        self.assertEqual(day06.number_of_lanternfish_counters(lanternfish_data, 256), 26984457539)
