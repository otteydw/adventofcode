# mypy: ignore-errors
# --- Day 5: Sunny with a Chance of Asteroids --- You're starting to sweat as
# the ship makes its way toward Mercury. The Elves suggest that you get the air
# conditioner working by upgrading your ship computer to support the Thermal
