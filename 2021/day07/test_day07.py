...
class TestSanta(unittest.TestCase):
    ...
    def test_fuel_to_converge_on_position(self):
        ...
        self.assertEqual(
            day07.fuel_to_converge_on_position(self.crab_positions, 10), 71
        )
    ...
    def test_fuel_to_converge_on_position_not_constant(self):
        ...
        self.assertEqual(
            day07.fuel_to_converge_on_position(
                self.crab_positions, 5, constant_rate=False
            ),
            168,
        )
        self.assertEqual(
            day07.fuel_to_converge_on_position(
                self.crab_positions, 2, constant_rate=False
            ),
            206,
        )
        self.assertEqual(
            day07.least_fuel_to_converge(self.crab_positions, constant_rate=False), 168
        )
