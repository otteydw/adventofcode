...
class TestSanta(unittest.TestCase):
    ...
    def test_visible_from_left(self):
        ...
        self.assertEqual(self.forest.visible_from_left(2, 2), False)  # center 3 (not visible from anywhere)
    ...
    def test_visible_from_right(self):
        ...
        self.assertEqual(self.forest.visible_from_right(2, 2), False)  # center 3 (not visible from anywhere)

    def test_visible_from_top(self):
        self.assertEqual(self.forest.visible_from_top(1, 1), True)  # Top left 5
        self.assertEqual(self.forest.visible_from_top(2, 2), False)  # center 3 (not visible from anywhere)
    ...
    def test_visible_from_bottom(self):
        ...
        self.assertEqual(self.forest.visible_from_bottom(2, 2), False)  # center 3 (not visible from anywhere)
