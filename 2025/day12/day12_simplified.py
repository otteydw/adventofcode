    ...
    def p1(self) -> int | None:
        ...
        for region in self.regions:
            ...
            if region.easy_p1():
                ...
                print("At least once region requires more advanced processing. Use `day12.py` instead.")
                return None
...
def part1(data: list[str]) -> int | None:
    problem = Problem(data)
    return problem.p1()


def solve(puzzle_input: str) -> list[int | None]:
